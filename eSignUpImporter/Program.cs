            ...
            if (candidatesToImport != null)
            {
                foreach (var candidate in candidatesToImport)
                {
                    ...
                    newEnrolmentRequest = new Models.EnrolmentRequest()
                    {
                        ...
                        RequestDate = DateTime.Now,
                        RequestStatus = "To Do",
                        Surname = candidate?.FamilyName?.SubstringOrDefault(0, 29),
                        FirstForename = candidate?.GivenNames?.TrimEnd().Split(" ").FirstOrDefault() ?? candidate?.GivenNames?.TrimEnd()?.SubstringOrDefault(0, 39),
                        Title = candidate?.Title?.SubstringOrDefault(0, 5),
                        DateOfBirth = candidate?.dateOfBirth,
                        Sex = candidate?.Sex,
                        Address1 = candidate?.AddLine1?.SubstringOrDefault(0, 99),
                        Address2 = candidate?.AddLine2?.SubstringOrDefault(0, 99),
                        Address3 = candidate?.AddLine3?.SubstringOrDefault(0, 99),
                        Address4 = candidate?.AddLine4?.SubstringOrDefault(0, 99),
                        ...
                        Tel = candidate?.TelNo?.SubstringOrDefault(0, 19),
                        Contact1 = candidate?.EmergencyContactFullName?.SubstringOrDefault(0, 99),
                        Contact1Tel = candidate?.EmergencyContactTelNumber?.SubstringOrDefault(0, 19),
                        DisabilityId = null,
                        NationalityId = candidate?.CountryOfNationality?.TrimEnd() == "GB" ? "XF" : candidate?.CountryOfNationality?.TrimEnd()?.SubstringOrDefault(0, 3),
                        EthnicGroupId = candidate?.EthnicityILRCode,
                        Email = candidate?.Email?.SubstringOrDefault(0, 99),
                        OfferingId = null,
                        PaymentStatus = "Pending",
                        RestrictedUseIndicator = null,
                        SentMarketingInfo = false,
                        ...
                        EmployerRelease = false,
                        EmployerPaying = false,
                        EmployerName = candidate?.PlacedRecruitments?.FirstOrDefault()?.Employer?.SubstringOrDefault(0, 59),
                        EmployerAddress1 = candidate?.PlacedRecruitments?.FirstOrDefault()?.ApprenticeshipEmployer?.VacancyEmployerSiteAddress1?.SubstringOrDefault(0, 99),
                        EmployerAddress2 = candidate?.PlacedRecruitments?.FirstOrDefault()?.ApprenticeshipEmployer?.VacancyEmployerSiteAddress2?.SubstringOrDefault(0, 99),
                        EmployerAddress3 = null,
                        EmployerAddress4 = null,
                        ...
                        PassDetailsTutor = false,
                        LearningDifficultyId = null,
                        MobileTel = candidate?.MobileNumber?.SubstringOrDefault(0, 19),
                        EmployerSizeTypeId = null,
                        EmploymentStatusBeforeEsfid = null,
                        UnemploymentDurationId = null,
                        Contact2 = candidate?.ParentGuardianName?.SubstringOrDefault(0, 99),
                        Contact2Tel = candidate?.ParentGuardianTelephoneNumber?.SubstringOrDefault(0, 19),
                        EuroResidentId = candidate?.OfficialUseEUCitizen ?? false,
                        CountryId = candidate?.HomeAddressCountry?.TrimEnd() == "GB" ? "XF" : candidate?.HomeAddressCountry?.TrimEnd()?.SubstringOrDefault(0, 2),
                        StudyElsewhere = false,
                        SchoolId = null,
                        Ni = candidate?.NINumber?.SubstringOrDefault(0, 8),
                        ...
                        OtherForenames =
                            candidate?.GivenNames?.TrimEnd().Split(" ").LastOrDefault() != candidate?.GivenNames?.TrimEnd().Split(" ").FirstOrDefault() ?
                                candidate?.GivenNames?.TrimEnd().Split(" ").LastOrDefault()?.SubstringOrDefault(0, 49) :
                                null,
                        RefNo = candidate?.StudentID?.SubstringOrDefault(0, 11),
                        Emareceipt = false,
                        Emanumber = null,
                        Emaconfirmed = false,
                        BritishNationality = candidate?.CountryOfNationality == "XF",
                        CountryOfResidence = candidate?.HomeAddressCountry?.SubstringOrDefault(0, 2),
                        DateOfEntryUk = null,
                        Refugee = false,
                        AsylumSeeker = false,
                        Permit = false,
                        ...
                        DiscussNeeds = false,
                        ExaminationArrangements = false,
                        PreviousSchool = candidate?.SchoolLastAttended?.SubstringOrDefault(0, 49),
                        EducationLastYear = false,
                        Homeless = false,
                        ...
                        FeenoLevel3 = false,
                        FeenoLevel2or3 = false,
                        KnownAs = candidate?.PreferredName?.SubstringOrDefault(0, 19),
                        PreviousStudentRefNo = candidate?.StudentID?.SubstringOrDefault(0, 11),
                        UniqueLearnerNo = candidate?.ULN?.SubstringOrDefault(0, 9),
                        WebApplicationId = candidate?.ID,
                        AbilityToShareId = 1,
                        ...
                        NumberOfYearsAtCurrentAddress = null,
                        WblplacementOrgId = null,
                        EmployerEmail = candidate?.PlacedRecruitments?.FirstOrDefault()?.EmployerContactEmail?.SubstringOrDefault(0, 99),
                        AdditionalLearningNeedsId = null,
                        GovernmentInitiative1Id = null,
                        GovernmentInitiative2Id = null,
                        SectorId = null,
                        ...
                        PassportExpiryDate = null,
                        PassportIssueDate = candidate?.passportIssueDate,
                        PassportNumber = candidate?.PassportNumber?.SubstringOrDefault(0, 19),
                        StudentVisaRequirementId = null,
                        Overseas = false,
                        RestrictedUseAllowContactByPost = false,
                        RestrictedUseAllowContactByTelephone = false,
                        ...
                        HasAdditionalSocialNeeds = false,
                        ApprenticeshipPathwayId = null,
                        Country = candidate?.HomeAddressCountry?.SubstringOrDefault(0, 49),
                        RestrictedUseAllowResearch = false,
                        RestrictedUseAllowLearningOpportunities = false,
                        RestrictedUseNoContactIllness = false,
                        ParentFirstName = candidate?.ParentGuardianName?.TrimEnd().Split(" ").FirstOrDefault() ?? candidate?.ParentGuardianName?.TrimEnd()?.SubstringOrDefault(0, 19),
                        ParentSurname =
                            candidate?.ParentGuardianName?.TrimEnd().Split(" ").LastOrDefault() != candidate?.ParentGuardianName?.TrimEnd().Split(" ").FirstOrDefault() ?
                                candidate?.ParentGuardianName?.TrimEnd().Split(" ").LastOrDefault()?.SubstringOrDefault(0, 39) :
                                null,
                        ParentTitle = null,
                        ParentAddress1 = candidate?.ParentGuardianHomeAddress?.SubstringOrDefault(0, 99),
                        ParentAddress2 = null,
                        ParentAddress3 = null,
                        ParentAddress4 = null,
                        ...
                        ParentCountry = null,
                        ParentPhoneNumber = null,
                        ParentMobileTel = candidate?.ParentGuardianTelephoneNumber?.SubstringOrDefault(0, 19),
                        ParentWorkTel = null,
                        ParentEmailAddress = candidate?.ParentGuardianEmail?.SubstringOrDefault(0, 99),
                        IsLivingWithParent = false,
                        ParentContactAllowedByPost = null,
                        ParentContactAllowedByEmail = null,
                        ParentContactAllowedByTelephone = null,
                        ...
                        PaymentMethodId = null,
                        VerificationTypeId = "999",
                        VerificationOtherDescription = candidate?.OfficialUseOtherEvidence?.SubstringOrDefault(0, 199),
                        LookedAfter = candidate?.InCare,
                        CareLeaver = candidate?.LeftCareRecently,
                        LearningSupportFundingDateFrom = null,
                        LearningSupportFundingDateTo = null,
                        ...
                        PebookingLearnerId = null,
                        WorkProgrammeParticipation = false,
                        Contact1EmailAddress = candidate?.EmergencyContactEmail?.SubstringOrDefault(0, 99),
                        Contact2EmailAddress = null,
                        GcsemathsAchievementId = null,
                        GcseenglishAchievementId = null,
                        CollegeChoice = null,
                        ...
                        Casid = null,
                        CasissueDate = null,
                        IdcardNumber = candidate?.DrivingLicenceNumber?.SubstringOrDefault(0, 19),
                        GcsemathsConditionOfFundingId = null,
                        GcseenglishConditionOfFundingId = null,
                        AchievedEnglishGcsebyEndOfYear11 = null,
                        AchievedMathsGcsebyEndOfYear11 = null,
                        ...
                        Contact1ContactTypeId = 1,
                        Contact1Title = null,
                        Contact1Address1 = candidate?.ParentGuardianHomeAddress?.SubstringOrDefault(0, 99),
                        Contact1Address2 = null,
                        Contact1Address3 = null,
                        Contact1Address4 = null,
                        ...
                        Contact1Country = null,
                        Contact1MobileTel = candidate?.ParentGuardianTelephoneNumber?.SubstringOrDefault(0, 19),
                        Contact1WorkTel = null,
                        IsLivingWithContact1 = false,
                        Contact1ContactAllowedByPost = null,
                        Contact1ContactAllowedByEmail = null,
